...
(function () {
  ...
  function start() {
    filterAll();
    const mo = new MutationObserver(debounce(filterAll, 200));
  ...
  function watchNavigation() {
    const wrap = fn => function (...a) { fn.apply(this, a); setTimeout(filterAll, 400); };
    history.pushState    = wrap(history.pushState);
    history.replaceState = wrap(history.replaceState);
    window.addEventListener('popstate', () => setTimeout(filterAll, 400));
  }
